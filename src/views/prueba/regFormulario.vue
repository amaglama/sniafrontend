...
<template>
    <div class="h-full">
        <div>
                <FormComp
                    :title="`${ typeForm === 'post'? 'REGISTRO' : (typeForm === 'update'? 'ACTUALIZACIÓN': 'RENOVACIÓN')} DE PROFESIONALES CGO`"
                        ...
                        <div class="gap-y-4">
                            ...
                            <div class="flex flex-wrap gap-y-4 justify-between">
                                ...
                                <InputForm
                                    ...
                                    :required="true"
                                    label="Especialidad"
                                    :errors="formErrors['especialidad']"
                                    :form-types="formTypes['especialidad']"
                                    class-name="w-48"
                                    />
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        setup(props, {emit}) {
            ...
            const states = ref([{name: 'LA Paz', code:'LP'},{name: 'Oruro', code:'or'},{name: 'beni', code:'be'},{name: 'pando', code:'pa'},]);
