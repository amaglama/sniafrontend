<template>
  <div class="flex flex-col">
    <div class="flex justify-center">
      <div class="flex justify-center my-2 min-w-[60vw">T
        <div v-for="(_, index) in steps" :key="index" class="flex items-center max-xl:w-32">
          <div
          ...
          <div
            ...
            class="flex-grow h-2 w-72 max-xl:w-fit"
            :class="{
    ...
    <div class="w-full rounded-lg overflow-y-auto h-[40vw]">
      <div>
        <!-- RegistroPersonalForm necesita un ref para la validación -->
...
import RegistroPersonalForm from '@/views/renca/public_pages/formulario_inscripcion/RegistroPersonalStepperForm.vue';
import { ref } from 'vue';
