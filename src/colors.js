...
export const getButtonColor = (color, isOutlined, hasHover, isActive = false) => {
  const colors = {
    ring: {
      ...
      primary: 'ring-secondary dark:ring-secondary text-white',
      secondary: 'ring-secondary dark:ring-secondary text-white',
      terciary: 'ring-secondary dark:ring-secondary text-white',
    },
    active: {
      white: 'bg-gray-100',
      ...
      primary: 'bg-primary dark:bg-primary text-white',
      secondary: 'bg-secondary dark:bg-secondary text-white',
      terciary: 'bg-terciary dark:bg-terciary text-white',
    },
    bg: {
      white: 'bg-white text-black',
      ...
      contrast: 'bg-gray-800 text-white dark:bg-white dark:text-black',
      sky: 'bg-sky-500 text-white dark:bg-white dark:text-black',
    ...
    borders: {
      ...
      primary: 'border-primary dark:border-primary text-white',
      secondary: 'border-secondary dark:border-secondary text-white',
      terciary: 'border-terciary dark:border-terciary text-white',
    },
    text: {
